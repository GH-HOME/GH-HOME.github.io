...
\begin{enumerate}[label={[\arabic*]}]
	...
	\item Guo Heng, et al. ``Multispectral Photometric Stereo for Spatially-Varying Spectral Reflectances" International Journal of Computer Vision. (IJCV minor revision). 
\end{enumerate}
