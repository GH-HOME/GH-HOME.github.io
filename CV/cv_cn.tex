...
%	\resumeItemListEnd
	...
	\begin{enumerate}[label={[\arabic*]}]
		...
		\item Kailong Zhang, Youwei Lyu, \textbf{Heng Guo}$^\dagger$, Si Li, Zhanyu Ma, Boxin Shi. ``PolarAnything: Diffusion-based Polarimetric Image Synthesis.'' IEEE International Conference on Computer Vision. (\textbf{ICCV 2025}).
